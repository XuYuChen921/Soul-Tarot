...
- Mac 负责客户档案、咨询排期、录音照片归档、本地 AI 处理和备份，也可作为微信视频咨询主设备；
- 服务 iPhone 继续负责微信沟通，并可作为移动视频咨询设备或 Mac 咨询的备用设备；
- 第二台 iPhone 在获得客户明确同意后负责独立录音、咨询现场拍照和移动提醒；
...
- 她在家中是否优先使用 Mac 微信进行视频咨询；
- “提前一天”和“提前一小时”提醒是只提醒她本人，还是同时生成待发送给客户的微信提醒任务；
- 报价单中的资质、年限、案例数和服务文案是否有可核验材料；
- 周期套餐的有效期、延期、赠送项目使用和退款/转让规则；
- 起名和空间项目的报价、首款、尾款及交付验收规则。
...
| 设备 | 建议职责 | 数据规则 |
|---|---|---|
| 服务 iPhone | 微信沟通、移动视频咨询、接收付款凭证、发送预约和交付消息 | 不作为长期档案库；微信里只保留业务沟通所需信息 |
| 第二台 iPhone | 在明确同意后独立录音、拍摄牌阵照片；安装配套应用接收预约提醒 | 导入 Mac 并校验成功后，按规则删除手机里的临时副本 |
| MacBook Air | 唯一主档案库、咨询排期、微信视频咨询、本地 AI、搜索、导出、备份 | 开启 FileVault；不与个人文件混存；自动锁定 |
...
她在固定场所咨询时，建议优先评估 Mac 微信视频：屏幕更大，可在旁边打开客户时间线和咨询工作区，手机则保留为录音和备用联络设备。
...
- Mac 微信异常时，可切换服务 iPhone，不改变该次预约和资料绑定；
...
| 预约排期 | 日/周/月视图、冲突检查、付款状态、改期、取消、迟到、爽约、Mac+iPhone 双端提醒 |
| 咨询记录 | 咨询类型、时长、价格、主题、牌卡、关键记录、后续任务 |
| 录音与照片 | 导入、播放、缩略图、哈希校验、客户绑定、版本与交付状态 |
| AI 工作台 | 录音转写、摘要草稿、行动项、关键词、时间戳证据、人工批准 |
| 提醒中心 | 默认提前一天和提前一小时提醒；提醒同步状态；客户微信提醒待发送/已发送 |
| 微信消息模板 | 预约确认、付款提醒、提前一天、提前一小时、改期确认、录音同意、咨询后交付、复访提醒 |
...
- 下一场咨询还有多久；
- 明天和一小时内有哪些预约、双端提醒是否已成功安排；
- 哪些客户已付款但未确认时间；
- 哪些预约等待改期；
- 哪些录音未导入、未转写或未交付；
- 哪些 AI 摘要待人工校对；
- 哪些客户需要回访；
- 哪些客户提醒消息待复制发送、哪些已经发送；
- 备份是否正常。
...
默认提醒对象是咨询师本人，同时创建“向客户发送微信提醒”的待办：

- **提前一天**：提醒她确认客户、付款、设备、网络、录音同意和是否需要改期；
- **提前一小时**：提醒她打开客户简报、准备牌卡、检查摄像头/麦克风/录音设备并进入勿扰模式；
- 点开提醒可选择“打开预约”“复制客户提醒文案”“稍后提醒”“标记已准备”；
- 客户消息默认由她确认后手动发送，系统只记录“待发送/已复制/已发送/无需发送”；
...
| 预约 Appointment | 开始/结束时间、状态、服务类型、成交价格、付款状态、视频设备、缓冲时间、变更历史 |
